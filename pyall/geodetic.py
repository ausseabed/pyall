...
def calculateRangeBearingFromGridPosition(easting1, northing1, easting2, northing2):
    ...
    bearing = 90 - (180 / math.pi) * math.atan2(
        northing2 - northing1, easting2 - easting1
    )
...
def calculateRangeBearingFromGeographicals(
...
if __name__ == "__main__":
    ...
    print("\n ****************************** \n")
    latitude1 = -((3.7203 / 60.0 + 57) / 60.0 + 37)
    longitude1 = (29.5244 / 60.0 + 25) / 60.0 + 144
    ...
    latitude2 = -((10.1561 / 60.0 + 39) / 60.0 + 37)
    longitude2 = (35.3839 / 60.0 + 55) / 60.0 + 143
    ...
    dist, alpha1Tp2, alpha21 = vinc_dist(
        f, a, latitude1, longitude1, latitude2, longitude2
    )
    ...
    longitude1 = (29.5244 / 60.0 + 25) / 60.0 + 144
    dist = 54972.271
    alpha1Tp2 = (5.37 / 60.0 + 52) / 60.0 + 306
    latitude2 = longitude2 = 0.0
    alpha21 = 0.0

    latitude2, longitude2, alpha21 = vincentyDirect(
        latitude1, longitude1, alpha1Tp2, dist
    )
...
def est_dist(latitude1, longitude1, latitude2, longitude2):
    ...
    return (
        math.sqrt(
            pow(math.fabs(latitude2 - latitude1), 2)
            + pow(math.fabs(longitude2 - longitude1) * c, 2)
        )
        * a
        * (1.0 - f + f * c)
    )
